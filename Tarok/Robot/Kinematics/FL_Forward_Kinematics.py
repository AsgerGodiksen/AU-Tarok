# Forward kinematics of front left leg of quadruped robot
import numpy as np
...
def FL_Forward_Kinematics(theta1,theta2,theta3):
    # Input:
...
def FL_T0_1(theta1, theta2, theta3):
    # Input:
        # theta1, theta2, theta3: joint angles in radians
    # Output:
...
def FL_T0_2(theta1, theta2, theta3):
    # Input:
        # theta1, theta2, theta3: joint angles in radians
    # Output:
...
def FL_T0_3(theta1, theta2, theta3):
    # Input:
        # theta1, theta2, theta3: joint angles in radians
    # Output:
...
def FL_P0_2(theta1, theta2, theta3):
    # Input:
        # theta1, theta2, theta3: joint angles in radians
    # Output:
        # P_org: Position of the second joint in the base frame of Left leg
...
def FL_P0_3(theta1, theta2, theta3):
    # Input:
        # theta1, theta2, theta3: joint angles in radians
    # Output:
        # P_org: Position of the third joint in the base frame of Left leg
