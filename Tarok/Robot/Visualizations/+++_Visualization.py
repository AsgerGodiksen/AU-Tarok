...
# Test script for visualization of linear positive in x, y and z motion of all 4 legs based on forward and inverse kinematics functions
import numpy as np
...
x_FL = np.piecewise(t, [t < 5, t >= 5], [lambda t: -0.06 + (0.12/5)*t + l_k/2, lambda t: 0.06 - (0.12/5)*(t-5) + l_k/2])  # X position in meters (linear wave from -0.06 to 0.06 and back to -0.06 in 10 seconds)
x_FR = np.piecewise(t, [t < 5, t >= 5], [lambda t: -0.06 + (0.12/5)*t + l_k/2, lambda t: 0.06 - (0.12/5)*(t-5) + l_k/2])  # X position in meters (linear wave from -0.06 to 0.06 and back to -0.06 in 10 seconds)
x_HL = np.piecewise(t, [t < 5, t >= 5], [lambda t: -0.06 + (0.12/5)*t - l_k/2, lambda t: 0.06 - (0.12/5)*(t-5) - l_k/2])  # X position in meters (linear wave from -0.06 to 0.06 and back to -0.06 in 10 seconds)
x_HR = np.piecewise(t, [t < 5, t >= 5], [lambda t: -0.06 + (0.12/5)*t - l_k/2, lambda t: 0.06 - (0.12/5)*(t-5) - l_k/2])  # X position in meters (linear wave from -0.06 to 0.06 and back to -0.06 in 10 seconds)
y_FL = y_HL = np.piecewise(t, [t < 5, t >= 5], [lambda t: -0.06 + (0.12/5)*t + w_k/2 + 0.078, lambda t: 0.06 - (0.12/5)*(t-5) + w_k/2 + 0.078])  # Y position in meters (linear wave from -0.06 to 0.06 and back to -0.06 in 10 seconds)
y_FR = y_HR = np.piecewise(t, [t < 5, t >= 5], [lambda t: -0.06 + (0.12/5)*t - w_k/2 - 0.078, lambda t: 0.06 - (0.12/5)*(t-5) - w_k/2 - 0.078])  # Y position in meters (linear wave from -0.06 to 0.06 and back to -0.06 in 10 seconds)
...
x_dot = np.piecewise(t, [t < 5, t >= 5], [lambda t: 0.12/5*np.ones_like(t), lambda t: -0.12/5*np.ones_like(t)])  # X velocity in meters/second (linear wave from 0.12 m/s to -0.12 m/s and back to 0.12 m/s in 10 seconds)
y_dot = np.piecewise(t, [t < 5, t >= 5], [lambda t: 0.12/5*np.ones_like(t), lambda t: -0.12/5*np.ones_like(t)])  # Y velocity in meters/second (linear wave from 0.12 m/s to -0.12 m/s and back to 0.12 m/s in 10 seconds)
...
### Plotting ###
# Plot wit 4 subplots showing joint angles theta1, theta2, theta3 for each leg over time
# y axis from -100 to 100 for all plots
...
ax.set_ylabel('Y (m)')
ax.set_zlabel('Z (m)')
ax.set_title('Leg Trajectories +++ Motion')
