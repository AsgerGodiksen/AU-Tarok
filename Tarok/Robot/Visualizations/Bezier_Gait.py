...
Total_Time_Steps = Swing_Time_Steps + Stand_Time_Steps

t = np.linspace(0, Total_Time_Scalar, Total_Time_Steps)
...
Theta_FL_ = np.degrees(Theta_FL)
Theta_FR_ = np.degrees(Theta_FR)
Theta_HL_ = np.degrees(Theta_HL)
Theta_HR_ = np.degrees(Theta_HR)
